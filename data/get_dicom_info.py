        ...
        try:    
            ...
            if (str(ds.SeriesNumber) == onenodule[2]) or (str(onenodule[2]) == str(0)):
                ...
                if signtemp == True:
                    ...
                    pix = truncate_hu(pix, 2000, -2000)

                    # if (x_loc < 28 or x_loc > (512 - 28)) or (y_loc < 28 or y_loc > (512 - 28)):
                    ...
                    scipy.misc.imsave("./img_512/" + str(scanid) + '_' + str(noduleid) + '_' + str(scan_list_id) + '.png', cut_img)
                    scipy.misc.imsave("./mask_512/" + str(scanid) + '_' + str(noduleid) + '_' + str(scan_list_id) + '_mask.png', cut_mask)
            else:
                print(scanid)
                print('not equal')
        except:
